...
_[Must be fixed before merge]_
...
_[Should be fixed before merge]_
...
_[Address soon, can merge with explicit acceptance of risk]_
...
_[Nice-to-haves, refactoring opportunities]_
...
- **Teach, don't preach**: Explain _why_ something matters, not just _what_ to change
