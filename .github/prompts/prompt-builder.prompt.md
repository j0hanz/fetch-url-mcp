...
- What is the intended filename for your prompt (e.g., `generate-react-component.prompt.md`)?P
...
- **File Operations**: `read/readFile`, `edit/editFiles`, `filesystem/*`
- **Search**: `search`
- **Thinking & Planning**: `sequential-thinking/*`
- **Web Interaction**: `apify/*`
