...
export const fetchLinksInputSchema = {
...
export const fetchMarkdownInputSchema = {
  url: z.string().min(1).describe('The URL to fetch'),
  extractMainContent: z
    .boolean()
    .optional()
...
export const fetchUrlsInputSchema = {
  urls: z
...
export const fetchLinksOutputSchema = {
...
export const fetchMarkdownOutputSchema = {
  url: z.string().describe('The fetched URL'),
  title: z.string().optional().describe('Page title'),
  fetchedAt: z
    .string()
...
export const fetchUrlsOutputSchema = {
  results: z
    .array(
      z.object({
        url: z.string().describe('The fetched URL'),
